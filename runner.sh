...
python3 -m main --exp_name=allcnnadvsgd --model_name=allcnn --optim_name=sgd --dataset_name=adv --adv=true
...
python3 -m main --exp_name=mobilevitadamwadv --model_name=mobilevit --optim_name=adamw --dataset_name=adv --adv=true
#sgd
...
python3 -m main --exp_name=mobilevitsgdadv --model_name=mobilevit --optim_name=sgd --dataset_name=adv --adv=true
