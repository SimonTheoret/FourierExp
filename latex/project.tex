...
Intuitively, this protocol allows us to test the sensibility of
certain models optimizer to low and high frequencies features and
observe how this sensibility evolves during training.
