...
training. Notably, all models were continuously learning to mostly rely
on low frequency features, independently of the training regimen. This
contradicts the findings of ~\citep{yin2020fourier}
...
% \begin{figure}
%   \centering
%   \includegraphics[scale=0.6]{assets/avg\_high\_pass\_fourier\_test\_acc.png}
%   \caption{Accuracy on the test set after filtering high frequencies
%     components}
% 	\label{fig:higherror}
% \end{figure}
