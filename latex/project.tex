...
normalize the images. In summary, we are trying to use
settings and parameters as close as possible to the ones used in the
...
their experiments. This factor limits the generality of their
findings, 
