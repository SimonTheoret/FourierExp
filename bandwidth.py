...
# TODO: modify this script to compute the accuracy of the trained models with varying bandwidth. 
...
def main_generic(
    ...
    optimizer = (
        ...
        if optim_name == "adamw"
        else torch.optim.SGD(model.parameters(), lr=lr, momentum=0.9, weight_decay=1e-4)
    )
    # Trainer
